...
describe('CartTable', () => {
  ...
  it('dispatches CHANGE_QUANTITY with +1 when plus button is clicked', async () => {
    ...
    // Verify the quantity increased in the rendered output
    // (actual dispatch testing would require more complex setup)
  });
  ...
  it('dispatches CHANGE_QUANTITY with -1 when minus button is clicked', async () => {
    ...
    // Verify the quantity decreased in the rendered output
  });
  ...
  it('dispatches REMOVE_FROM_CART when remove button is clicked', async () => {
    ...
    // Verify the item was removed from the rendered output
  });
